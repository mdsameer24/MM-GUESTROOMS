  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
        <h1 style={{ fontSize: '3rem', marginBottom: '1rem' }}>Cancellation <span className="text-gold">Policy</span></h1>
        <p className="text-muted" style={{ maxWidth: '600px', margin: '0 auto' }}>
          Understand our terms regarding booking modifications and cancellations.
        </p>
      </div>
      ...
      <div className="card-luxury" style={{ padding: '3rem', backgroundColor: 'var(--surface-color)', borderRadius: 'var(--border-radius-lg)', border: '1px solid var(--border-color)', maxWidth: '800px', margin: '0 auto' }}>
        <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: 'var(--primary-gold)' }}>Standard Policy</h2>
